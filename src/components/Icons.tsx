...
export const Dumbbell: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      ...
      <path d="m2 16 6-6"/>
      <path d="m16 2 6 6"/>
      <path d="M21 16.5c0 1.5-1.5 3-3 3l-1.5-1.5c-1-.8-2-2-3-3l-1.5-1.5c-1-.8-2-2-3-3L4.5 9c-1.5 0-3 1.5-3 3s1.5 3 3 3l1.5-1.5c1-.8 2-2 3-3l1.5-1.5c1-.8 2-2 3-3l1.5-1.5c1.5 0 3 1.5 3 3Z"/>
    </svg>
  );
